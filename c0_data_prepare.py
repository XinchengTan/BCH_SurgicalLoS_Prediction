...
def prepare_data(data_fp, dtime_fp, cpt_fp, cpt_grp_fp, diag_fp, exclude2021=True, force_weight=False):
  """
  ...
  dashb_df = dashb_df.join(cpt_df.set_index('SURG_CASE_KEY'), on='SURG_CASE_KEY', how='inner')\
    .rename(columns={'CPT_CODE': 'CPTS',
             ...
             'CPT_GROUP': 'CPT_GROUPS'})  # It's okay to discard cases without CPTs, since it's required
