...
# Feature columns
FEATURE_COLS_NO_WEIGHT = ['SURG_CASE_KEY', 'SEX_CODE', 'AGE_AT_PROC_YRS', CPTS, CPT_GROUPS, 'PRIMARY_PROC', CCSRS] \
                         + OS_CODES  # , 'ICD10S'
...
FEATURE_COLS_NO_WEIGHT_STATE_LANG_INTERP = FEATURE_COLS_NO_WEIGHT + ['STATE_CODE', 'LANGUAGE_DESC', 'INTERPRETER_NEED'] # , 'ICD10S'
FEATURE_COLS_NO_WEIGHT_ALLMEDS = FEATURE_COLS_NO_WEIGHT + DRUG_COLS + \
                                 ['STATE_CODE', 'LANGUAGE_DESC', 'INTERPRETER_NEED']  # , 'ICD10S'
