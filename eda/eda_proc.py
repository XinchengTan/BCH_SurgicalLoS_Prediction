...
def pproc_los_median_eda(dashb_df, outcome=NNT, preprocess_y=True, min_cnt=5):
  total = dashb_df.shape[0]
  df = dashb_df[[LOS, NNT, PRIMARY_PROC, 'SURG_CASE_KEY']]
  ...
  sns.boxplot(data=df_filtered, x='los_median', y=NNT, orient='h', ax=ax)  # scale='width',
  ax.set_title('Primary Procedure LOS Median vs Outcome Class', fontsize=18, y=1.01)
