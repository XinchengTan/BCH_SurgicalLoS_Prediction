...
python3 deploy_tune_main.py --oh_cols ccsr cptgrp --n_iter $iter --models $model --percase_cnt_vars ccsr cpt med123 --scaler $scaler --n_jobs 20
python3 deploy_tune_main.py --oh_cols ccsr pproc --n_iter $iter --models $model --percase_cnt_vars ccsr cpt med123 --scaler $scaler --n_jobs 20
python3 deploy_tune_main.py --oh_cols cpt --n_iter $iter --models $model --percase_cnt_vars ccsr cpt med123 --scaler $scaler --n_jobs 20
python3 deploy_tune_main.py --oh_cols ccsr cpt --n_iter $iter --models $model --percase_cnt_vars ccsr cpt med123 --scaler $scaler --n_jobs 20
